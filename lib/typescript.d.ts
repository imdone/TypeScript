...
declare namespace ts {
    ...
    interface TransformationContext {
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:61 gh:62
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:168 gh:169
         * before returning the `NodeTransformer` callback.
         */
