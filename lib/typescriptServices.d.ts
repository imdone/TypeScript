...
declare namespace ts {
    ...
    interface TransformationContext {
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:122 gh:123
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:232 gh:233
         * before returning the `NodeTransformer` callback.
         */
