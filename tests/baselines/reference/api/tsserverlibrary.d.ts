...
declare namespace ts {
    ...
    interface TransformationContext {
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:741 gh:742
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:396 gh:397
         * before returning the `NodeTransformer` callback.
         */
...
declare namespace ts.server.protocol {
    ...
    /**
     * A request to get TODO comments from the file id:482 gh:483
     */
    ...
    interface TodoCommentRequestArgs extends FileRequestArgs {
        /**
         * Array of target TodoCommentDescriptors that describes TODO comments to be found id:392 gh:393
         */
     ...
     * NOTE: this us query-only operation and does not generate any output on disk. id:391 gh:392
     */
