...
module TypeScript {
    ...
    export class AST extends ASTSpan {
        ...
        // REVIEW: for diagnostic purposes id:514 gh:515
    ...
    export class UnaryExpression extends Expression {
        ...
        public addToControlFlow(context: ControlFlowContext): void {
            ...
            // TODO: add successor as catch block/finally block if present id:773 gh:774
        ...
        public typeCheck(typeFlow: TypeFlow) {
            switch (this.nodeType) {
                ...
                case NodeType.Void:
                    // REVIEW - Although this is good to do for completeness's sake, id:496 gh:497
    ...
    export class ImportDeclaration extends ModuleElement {
        ...
        public emit(emitter: Emitter, tokenId: TokenID, startLine: boolean) {
            ...
            // REVIEW: Only modules may be aliased for now, though there's no real id:609 gh:610
    ...
    export class WhileStatement extends Statement {
        ...
        public addToControlFlow(context: ControlFlowContext): void {
            ...
            // TODO: check for while (true) and then only continue if afterLoop has predecessors id:495 gh:496
    ...
    export class DoWhileStatement extends Statement {
        ...
        public addToControlFlow(context: ControlFlowContext): void {
            ...
            if (!(context.noContinuation)) {
                ...
                loopEnd.addSuccessor(loopStart);
                context.addContent(this.cond);
                // TODO: check for while (true)  id:516 gh:517
                context.current = afterLoop;
    ...
    export class CaseStatement extends Statement {
        ...
        // TODO: more reasoning about unreachable cases (such as duplicate literals as case expressions) id:774 gh:775
        ...
        public addToControlFlow(context: ControlFlowContext) {
            ...
            // TODO: fall-through from previous (+ to end of switch) id:498 gh:499
            if (this.expr) {
    ...
    export class Catch extends Statement {
        ...
        public typeCheck(typeFlow: TypeFlow) {
            ...
            // REVIEW: This is obviously bad form, since we're counting on the internal id:611 gh:612
