...
module Harness {
    ...
    export module Compiler {
        ...
        export class Type {
            ...
            // TODO: Find an implementation of isIdenticalTo that works. id:605 gh:607
            ...
            private getTypeInfoName(ast : TypeScript.AST) {
                ...
                switch (ast.nodeType) {
                    ...
                    case TypeScript.NodeType.FuncDecl:
                        ...
                        break;
                    default:
                        // TODO: is there a reason to mess with all the special cases above and not just do this (ie take whatever property is there and works?) id:490 gh:491
                        var a = <any>ast;
        ...
        export function addUnit(code: string, unitName?: string, isResident?: boolean, isDeclareFile?: boolean, references?: TypeScript.IFileReference[]) {
            ...
            if (!script) {
                // TODO: make this toggleable, shouldn't be necessary once typecheck bugs are cleaned up id:512 gh:513
        ...
        export function compileString(code: string, unitName: string, callback: (res: Compiler.CompilerResult) => void , context?: CompilationContext, references?: TypeScript.IFileReference[]) {
            ...
            var errors;
            if (usePull) {
                // TODO: no emit support with pull yet id:772 gh:773
        ...
        export function defineCompilationContextForTest(filename: string, dependencies: TestCaseParser.TestUnitData[]): CompilationContext {
            ...
            if (dependencies.length == 0) {
                ...
                var addedFiles = [];
                var precompile = () => {
                    // REVIEW: if any dependency has a triple slash reference then does postCompile potentially have to do a recreate since we can't update references with updateUnit? id:494 gh:495
